"""Pager0 Auth0 Landing Page — production-grade SaaS login experience.
...
<header class="header">
  <div class="header-inner">
    <div class="h-left">
      <a href="/" class="logo">PAGER<span>.0</span></a>
      <ul class="nav">
...
<footer class="footer">
  <div class="footer-inner">
    <div class="footer-left">&copy; 2026 <strong>Pager0</strong> &mdash; Deep Agents Hackathon</div>
...
async def auth_landing():
    """Serve the Auth0 landing page at /auth (fallback when React frontend is not built)."""
